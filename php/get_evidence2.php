<html>
  <?php
     ...
     $query = "SELECT *
	             FROM Evidence 
               WHERE CaseColloquialName = '".str_replace("'", "''", $_POST["CaseColloquialName"])."' AND CrimeNo = '".$_POST["CrimeNo"]."' AND (Picture IS NOT NULL OR Video IS NOT NULL)  
  ...
  ?>
  <option value="null">There are no pieces of evidence for the selected crime and case.</option>;
  <?php
     }
  ?>
</html>
